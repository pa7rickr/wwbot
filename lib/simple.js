...
exports.makeWASocket = (args, store) => {
    ...
    */
     ...
     * @param {Object} options 
     */
    conn.sendTextWithMentions = async (jid, text, quoted, options = {}) => conn.sendMessage(jid, { text: text.replace(/@s\.whatsapp\.net/g, ''), mentions: [...text.matchAll(/@([0-9]{5,16}|0)/g)].map(v => v[1] + '@s.whatsapp.net'), ...options }, { quoted, ...options })
